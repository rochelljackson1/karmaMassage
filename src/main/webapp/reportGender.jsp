<%@ page import="com.uh.rachel.util.reportClasses.reportGender" %>
...
<table>
    ...
    <% Vector<reportGender> v = DataHandler.getReportGender();
        for (reportGender c : v) {
    %>
    <tr>
